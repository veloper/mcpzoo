...
from src.backend.mise import MiseTomlFile, MiseTool
...
class ServerDirectory(BaseModel):
    ...
    server_config: ServerConfiguration = Field(..., description="MCP server configuration")
    ...
    @classmethod
    def from_server_config(cls, server_config: ServerConfiguration):
        """
        Create McpServerDirectory from MCPServerConfig.
        """
        deepcopy = ServerConfiguration.model_validate_json(server_config.model_dump_json())
        ...
        data = {
            ...
            "supervisord_conf_file": SupervisorConfFile.from_mcp_server_config(deepcopy),
